...
def obtener_catalogo():
    try:
        ...
        if connection.is_connected():
            ...
            # Obtener productos
            cursor.execute("SELECT PK_idProducto, Fk_idCategoria, Descripcion, Precio, Imagen FROM producto")
...
if __name__ == '__main__':
    ...
    app.run(debug=True, host='0.0.0.0', port=7000)  # Cambiar puerto si es necesario
